...
TEST(t_dlt_message_header_flags_v2, normal)
{
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        printf("%s \n", text);
        EXPECT_LE(
            DLT_RETURN_OK, dlt_message_header_flags_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_ALL, 0));
        printf("%s \n", text);
    }
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        printf("%s \n", text);
        EXPECT_LE(
            DLT_RETURN_OK, dlt_message_header_flags_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_ALL, 1));
        printf("%s \n", text);
    }
...
TEST(t_dlt_message_header_flags_v2, nullpointer)
{
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGCNT, 0));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGTYPE, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGSUBTYPE, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_VNVSTATUS, 0));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGCNT, 1));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGTYPE, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGSUBTYPE, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_VNVSTATUS, 1));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGCNT, 0));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGTYPE, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGSUBTYPE, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_VNVSTATUS, 0));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGCNT, 1));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGTYPE, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_MSGSUBTYPE, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(NULL, text, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_VNVSTATUS, 1));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_NONE, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_TIME, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR,
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_APID, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_CTID, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR,
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_ALL, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_NONE, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_TIME, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR,
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_APID, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_CTID, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR,
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_header_flags_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_HEADER_SHOW_ALL, 1));
...
TEST(t_dlt_message_payload_v2, normal)
{
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        printf("%s \n", text);
        EXPECT_LE(
            DLT_RETURN_OK, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 0));
        printf("%s \n", text);
    }
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        printf("%s \n", text);
        EXPECT_LE(
            DLT_RETURN_OK, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 1));
        printf("%s \n", text);
    }
...
TEST(t_dlt_message_payload_v2, abnormal)
{
    ...
    EXPECT_GE(
        ...
        dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_PLAIN, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_HTML, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 0));
    ...
    EXPECT_GE(
        ...
        dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_PLAIN, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_HTML, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, text, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 1));
...
TEST(t_dlt_message_payload_v2, nullpointer)
{
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_HTML, 0));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 0));
    ...
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_MIXED_FOR_HTML, 1));
    EXPECT_GE(
        DLT_RETURN_ERROR, dlt_message_payload_v2(&file.msgv2, NULL, DLT_DAEMON_TEXTSIZE, DLT_OUTPUT_ASCII_LIMITED, 1));
...
TEST(t_dlt_message_argument_print_v2, normal)
{
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        EXPECT_GE(
            DLT_RETURN_OK, dlt_message_argument_print_v2(
                               &file.msgv2, DLT_TYPE_INFO_BOOL, pptr, pdatalength, text, DLT_DAEMON_TEXTSIZE, 0, 1));
        /*printf("### ARGUMENT:%s\n", text); */
    }
    ...
    for (int i = 0; i < file.counter; i++) {
        ...
        EXPECT_GE(
            DLT_RETURN_OK, dlt_message_argument_print_v2(
                               &file.msgv2, DLT_TYPE_INFO_RAWD, pptr, pdatalength, text, DLT_DAEMON_TEXTSIZE, 0, 1));
        /*printf("### ARGUMENT:%s\n", text); */
    }
