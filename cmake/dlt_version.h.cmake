...
#define DLT_SYSTEMD_ENABLE_STR "+SYSTEMD"
#else
#define DLT_SYSTEMD_ENABLE_STR "-SYSTEMD"
#endif

#ifdef DLT_SYSTEMD_WATCHDOG_ENABLE
#define DLT_SYSTEMD_WATCHDOG_ENABLE_STR "+SYSTEMD_WATCHDOG"
#else
#define DLT_SYSTEMD_WATCHDOG_ENABLE_STR "-SYSTEMD_WATCHDOG"
#endif

#ifdef DLT_TEST_ENABLE
#define DLT_TEST_ENABLE_STR "+TEST"
#else
#define DLT_TEST_ENABLE_STR "-TEST"
#endif

#ifdef DLT_SHM_ENABLE
#define DLT_SHM_ENABLE_STR "+SHM"
#else
#define DLT_SHM_ENABLE_STR "-SHM"
#endif
