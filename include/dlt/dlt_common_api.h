...
/**
 * Register context including application (with default log level and default
 * trace status) Common API with DLT Embedded
 * @param CONTEXT object containing information about one special logging
 * context
 ...
 */
/*****************************************/
#define DLT_LOG0(CONTEXT, LOGLEVEL) DLT_LOG(CONTEXT, LOGLEVEL)
/*****************************************/
#define DLT_LOG1(CONTEXT, LOGLEVEL, ARGS1) DLT_LOG(CONTEXT, LOGLEVEL, ARGS1)
/*****************************************/
...
/*****************************************/
#define DLT_LOG7(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,  \
                 ARGS7)                                                        \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, ARGS7)
/*****************************************/
#define DLT_LOG8(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,  \
                 ARGS7, ARGS8)                                                 \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8)
/*****************************************/
#define DLT_LOG9(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,  \
                 ARGS7, ARGS8, ARGS9)                                          \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9)
/*****************************************/
#define DLT_LOG10(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10)                                 \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10)
/*****************************************/
#define DLT_LOG11(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11)                         \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11)
/*****************************************/
#define DLT_LOG12(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12)                 \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12)
/*****************************************/
#define DLT_LOG13(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13)         \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13)
/*****************************************/
#define DLT_LOG14(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14) \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14)
/*****************************************/
#define DLT_LOG15(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14, \
                  ARGS15)                                                      \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14,       \
            ARGS15)
/*****************************************/
#define DLT_LOG16(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6, \
                  ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14, \
                  ARGS15, ARGS16)                                              \
    DLT_LOG(CONTEXT, LOGLEVEL, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5, ARGS6,       \
            ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13, ARGS14,       \
 ...
 * mode) Common API with DLT Embedded
 * @param CONTEXT object containing information about one special logging
 * context
 * @param LOGLEVEL the log level of the log message
...
/*****************************************/
#define DLT_LOG_ID5(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,      \
                    ARGS5)                                                     \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5)
/*****************************************/
#define DLT_LOG_ID6(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,      \
                    ARGS5, ARGS6)                                              \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6)
/*****************************************/
#define DLT_LOG_ID7(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,      \
                    ARGS5, ARGS6, ARGS7)                                       \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7)
/*****************************************/
#define DLT_LOG_ID8(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,      \
                    ARGS5, ARGS6, ARGS7, ARGS8)                                \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8)
/*****************************************/
#define DLT_LOG_ID9(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,      \
                    ARGS5, ARGS6, ARGS7, ARGS8, ARGS9)                         \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9)
/*****************************************/
#define DLT_LOG_ID10(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10)                \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10)
/*****************************************/
#define DLT_LOG_ID11(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11)        \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11)
/*****************************************/
#define DLT_LOG_ID12(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11,        \
                     ARGS12)                                                   \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12)
/*****************************************/
#define DLT_LOG_ID13(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11,        \
                     ARGS12, ARGS13)                                           \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13)
/*****************************************/
#define DLT_LOG_ID14(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11,        \
                     ARGS12, ARGS13, ARGS14)                                   \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13,     \
               ARGS14)
/*****************************************/
#define DLT_LOG_ID15(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11,        \
    ...
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ...
               ARGS14, ARGS15)
/*****************************************/
#define DLT_LOG_ID16(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4,     \
                     ARGS5, ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11,        \
                     ARGS12, ARGS13, ARGS14, ARGS15, ARGS16)                   \
    DLT_LOG_ID(CONTEXT, LOGLEVEL, MSGID, ARGS1, ARGS2, ARGS3, ARGS4, ARGS5,    \
               ARGS6, ARGS7, ARGS8, ARGS9, ARGS10, ARGS11, ARGS12, ARGS13,     \
               ARGS14, ARGS15, ARGS16)
 ...
 * Common API with DLT Embedded
 * In the future in none verbose mode the string will not be sent via DLT
 * message.
