                                     ...
                                     int verbose)
{
    ...
    /* Validate that the message contains enough data for apid + ctidlen */
    ...
    /* Validate that the message contains enough data for ctid + com */
                                      ...
                                      int verbose)
{
    ...
    apid = req.apid;
    apid_length = req.apidlen;
    ctid = req.ctid;
    ctid_length = req.ctidlen;
