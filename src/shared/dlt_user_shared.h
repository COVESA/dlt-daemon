...
/**
 * This is the header of each message to be exchanged between application and
 * daemon.
 */
typedef struct {
...
/**
 * This is the internal message content to exchange control msg register app
 * information between application and daemon.
 */
typedef struct {
...
/**
 * This is the internal message content to exchange control msg unregister app
 * information between application and daemon.
 */
typedef struct {
    char apid[DLT_ID_SIZE]; /**< application id */
...
/**
 * This is the internal message content to exchange control msg register
 * information between application and daemon.
 */
typedef struct {
    char apid[DLT_ID_SIZE];      /**< application id */
    char ctid[DLT_ID_SIZE];      /**< context id */
    int32_t log_level_pos;       /**< offset in management structure on
...
/**
 * This is the internal message content to exchange control msg unregister
 * information between application and daemon.
 */
typedef struct {
    char apid[DLT_ID_SIZE]; /**< application id */
...
/**
 * This is the internal message content to exchange control msg injection
 * information between application and daemon.
 */
typedef struct {
    int32_t log_level_pos;       /**< offset in management structure on
...
/**
 * This is the internal message content to exchange information about
 * application log level and trace stats between application and daemon.
 */
typedef struct {
    char apid[DLT_ID_SIZE]; /**< application id */
    uint8_t log_level;      /**< log level */
...
/**
 * This is the internal message content to set the logging mode: off, external,
 * internal, both.
 */
typedef struct {
    int8_t log_mode; /**< the mode to be used for logging: off, external,
                        internal, both */
} DLT_PACKED DltUserControlMsgLogMode;

/**
 * This is the internal message content to get the logging state: 0 = off, 1 =
 * external client connected.
 */
typedef struct {
    int8_t log_state; /**< the state to be used for logging state: 0 = off, 1 =
                         external client connected */
} DLT_PACKED DltUserControlMsgLogState;

/**
 * This is the internal message content to get the number of lost messages
...
/**************************************************************************************************
 * The folowing functions are used shared between the user lib and the daemon
 *implementation
 **************************************************************************************************/
...
/**
 * Atomic write to file descriptor, using vector of 2 elements  with a timeout
 * of 1s
 * @param handle file descriptor
 * @param ptr1 generic pointer to first segment of data to be written
 * @param len1 length of first segment of data to be written
...
/**
 * Atomic write to file descriptor, using vector of 3 elements with a timeout of
 * 1s
 * @param handle file descriptor
 * @param ptr1 generic pointer to first segment of data to be written
 * @param len1 length of first segment of data to be written
