...
#define DLT_OFFLINE_LOGSTORAGE_MAX_FILE_NAME_LEN                                                                       \
    100 /* Maximum file name length of the log file including path under mount point */
...
#define DLT_OFFLINE_LOGSTORAGE_INDEX_OFFSET (DLT_OFFLINE_LOGSTORAGE_TIMESTAMP_LEN + DLT_OFFLINE_LOGSTORAGE_INDEX_LEN)
#define DLT_OFFLINE_LOGSTORAGE_MAX_LOG_FILE_LEN                                                                        \
    (DLT_OFFLINE_LOGSTORAGE_MAX_FILE_NAME_LEN + DLT_OFFLINE_LOGSTORAGE_TIMESTAMP_LEN                                   \
...
#define DLT_OFFLINE_LOGSTORAGE_MAX_PATH_LEN (DLT_OFFLINE_LOGSTORAGE_MAX_LOG_FILE_LEN + DLT_MOUNT_PATH_MAX + 3)
...
struct DltLogStorageFilterConfig {
    ...
    int (*dlt_logstorage_sync)(
        DltLogStorageFilterConfig* config, DltLogStorageUserConfig* uconfig, char* dev_path, int status);
