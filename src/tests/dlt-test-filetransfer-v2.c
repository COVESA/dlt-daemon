...
int main(int argc, char* argv[])
{
    ...
    DLT_REGISTER_APP_V2("FLTR", "Test Application filetransfer");

    /*Register the context of the main program at the dlt-daemon */
    DLT_REGISTER_CONTEXT_V2(mainContext, "MAIN", "Main context for filetransfer test");

    /*Register the context in which the file transfer will be logged at the dlt-daemon */
    DLT_REGISTER_CONTEXT_V2(fileContext, "FLTR", "Test Context for filetransfer");
    ...
    DLT_UNREGISTER_CONTEXT_V2(fileContext);
    /*Unregister the context of the main program from the dlt-daemon */
    DLT_UNREGISTER_CONTEXT_V2(mainContext);
