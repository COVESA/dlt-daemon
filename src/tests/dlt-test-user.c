...
int main(int argc, char *argv[])
{
    ...
    DLT_REGISTER_CONTEXT(context_macro_callback, "CBM",
    ...
    dlt_register_context(&context_function_callback, "CBF",
...
int test2m(void)
{
    ...
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("string"),
            DLT_STRING("Hello world"));
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("utf8"),
            DLT_UTF8("Hello world"));
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("bool"),
            DLT_BOOL(1));
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("int"),
            DLT_INT(INT32_MIN)); /* (-2147483647-1) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("int8"),
            DLT_INT8(INT8_MIN)); /*          (-128) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("int16"),
            DLT_INT16(INT16_MIN)); /*      (-32767-1) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("int32"),
            DLT_INT32(INT32_MIN)); /* (-2147483647-1) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("int64"),
            DLT_INT64(INT64_MIN)); /* (-__INT64_C(9223372036854775807)-1) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("uint"),
            DLT_UINT(UINT32_MAX)); /*   (4294967295U) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("uint8"),
            DLT_UINT8(UINT8_MAX)); /*           (255) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("uint16"),
            DLT_UINT16(UINT16_MAX)); /*         (65535) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("uint32"),
            DLT_UINT32(UINT32_MAX)); /*   (4294967295U) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("uint64"),
            DLT_UINT64(UINT64_MAX)); /* (__UINT64_C(18446744073709551615)) */
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("float32"),
            DLT_FLOAT32(FLT_MIN), DLT_FLOAT32(FLT_MAX));
    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("float64"),
            DLT_FLOAT64(DBL_MIN), DLT_FLOAT64(DBL_MAX));

    for (num2 = 0; num2 < 10; num2++)
        buffer[num2] = (char)num2;

    DLT_LOG(context_macro_test[1], DLT_LOG_INFO, DLT_STRING("raw"),
            DLT_RAW(buffer, 10));
...
int test4m(void)
{
    ...
    DLT_LOG(context_macro_test[3], DLT_LOG_INFO, DLT_STRING("1"),
            DLT_RAW(buffer, 1));
    DLT_LOG(context_macro_test[3], DLT_LOG_INFO, DLT_STRING("16"),
            DLT_RAW(buffer, 16));
    DLT_LOG(context_macro_test[3], DLT_LOG_INFO, DLT_STRING("256"),
            DLT_RAW(buffer, 256));
    DLT_LOG(context_macro_test[3], DLT_LOG_INFO, DLT_STRING("1024"),
            DLT_RAW(buffer, 1024));
...
int test5m(void)
{
    ...
    DLT_LOG_STRING_INT(context_macro_test[4], DLT_LOG_INFO,
                       "String output: ", -42);

    DLT_LOG(context_macro_test[4], DLT_LOG_INFO,
            DLT_STRING("Next line: DLT_LOG_STRING_UINT"));
    DLT_LOG_STRING_UINT(context_macro_test[4], DLT_LOG_INFO,
                        "String output: ", 42);
...
int test6m(void)
{
    ...
    DLT_LOG_STRING(context_macro_test[5], DLT_LOG_INFO,
...
int test10m(void)
{
    ...
    /* Test 10: test minimum, regular and maximum timestamp for both verbose and
     * non verbose mode*/

    printf("Test10m: (Macro IF) Test user-supplied time stamps\n");
    DLT_LOG_STRING(context_info, DLT_LOG_INFO,
                   "Test10: (Macro IF) Test user-supplied timestamps");
    ...
    sleep(2);
    DLT_LOG(context_info, DLT_LOG_INFO,
            DLT_STRING("Test10: (Macro IF) finished"));
...
int test5f(void)
{
    ...
    dlt_log_string(&(context_function_test[4]), DLT_LOG_INFO,
    ...
    dlt_log_string_int(&(context_function_test[4]), DLT_LOG_INFO,
                       "String output: ", -42);

    dlt_log_string(&(context_function_test[4]), DLT_LOG_INFO,
                   "Next line: dlt_log_string_uint()");
    dlt_log_string_uint(&(context_function_test[4]), DLT_LOG_INFO,
                        "String output: ", 42);
...
int test10f(void)
{
    ...
    if (dlt_user_log_write_start(&context_info, &context_data, DLT_LOG_INFO) >
        ...
        dlt_user_log_write_string(
            &context_data,
            "Test10: (Function IF) Test user-supplied time stamps");
        dlt_user_log_write_finish(&context_data);
    }
    ...
    for (int i = 0; i < 3; i++) {
        ...
        dlt_verbose_mode();
        if (dlt_user_log_write_start(&context_function_test[9], &context_data,
                                     DLT_LOG_INFO) > 0) {
