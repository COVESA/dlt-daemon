 ...
 */
extern DltReturnValue multiple_files_buffer_init(
    MultipleFilesRingBuffer* files_buffer, const char* directory, int file_size, int max_size,
    bool filename_timestamp_based, bool append, const char* filename_base, const char* filename_ext);
 ...
 * @return negative value if there was an error.
 */
extern DltReturnValue multiple_files_buffer_write(
 ...
 */
void multiple_files_buffer_rotate_file(MultipleFilesRingBuffer* files_buffer, int size);
...
DltReturnValue multiple_files_buffer_write_chunk(
    const MultipleFilesRingBuffer* files_buffer, const unsigned char* data, int size);
 ...
 */
unsigned int multiple_files_buffer_storage_dir_info(
    const char* path, const char* file_name, char* newest, char* oldest);
