 ...
 * will be returned.
 */
extern int dlt_user_log_file_complete(DltContext *fileContext,
 ...
 * will be returned.
 */
extern int dlt_user_log_file_packagesCount(DltContext *fileContext,
                                           const char *filename);
 ...
 * will be returned.
 */
extern int dlt_user_log_file_infoAbout(DltContext *fileContext,
                                       const char *filename);
 ...
 * will be returned.
 */
extern int dlt_user_log_file_header_alias(DltContext *fileContext,
                                          const char *filename,
                                          const char *alias);
 ...
 */
extern int
dlt_user_log_file_data_cancelable(DltContext *fileContext, const char *filename,
 ...
 * will be returned.
 */
extern int dlt_user_log_file_data(DltContext *fileContext, const char *filename,
                                  int packageToTransfer, unsigned int timeout);
 ...
 * will be returned.
 */
extern int dlt_user_log_file_end(DltContext *fileContext, const char *filename,
                                 int deleteFlag);
